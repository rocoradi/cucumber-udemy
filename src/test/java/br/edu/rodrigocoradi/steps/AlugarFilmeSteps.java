...
import br.edu.rodrigocoradi.servicos.AluguelService;
...
public class AlugarFilmeSteps {
	...
	@Então("^a pontuação recebida será (\\d+) pontos$")
	public void aPontuaçãoRecebidaSeráPontos(int arg1) throws Throwable {
